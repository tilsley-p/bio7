...
- the participant should be shown a printed version of the corresponding glossary (french or english) with word definitions.
- ask them to go through and read the definitions of words they don't know. 
...
2. Run B_RunRMET.m to run the actual task with the participant 

- the participant has 5s to look at each image.
- the participant then has max 12s to choose the corresponding emotion once the mouse re-appears in the centre of the screen (else it times out and continues automatically).
