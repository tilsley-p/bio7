...
setup.data_mat_name = ['sub-' setup.subject_type '' int2str(setup.subject_no) '_acq-test_task-rmet_' date '_' time '.mat']; 
setup.data_csv_name = ['sub-' setup.subject_type '' int2str(setup.subject_no) '_acq-test_task-rmet_data_' date '_' time '.csv'];
setup.results_csv_name = ['sub-' setup.subject_type '' int2str(setup.subject_no) '_acq-test_task-rmet_results_' date '_' time '.csv'];
